...
- **Data**: Visualization layers use PMTiles (vectors) or COG+TiTiler (rasters).  Backend does SQL queries via MCP to DuckDB on parquet files indexed with H3.
- **Deployment**: Kubernetes (k8s)
- **Configuration**: `app/layers-config.json` -- generated by scripts/stac-to-layers-config.py
